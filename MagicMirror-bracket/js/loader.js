...
const Loader = (function () {
	...
	const cacheBuster = window.mmCacheBuster || Date.now();
		...
		switch (extension.toLowerCase()) {
			case "js":
				return new Promise((resolve) => {
					...
					script.src = fileName + (fileName.includes("?") ? "&" : "?") + "v=" + cacheBuster;
			...
			case "css":
				return new Promise((resolve) => {
					...
					// Add cache-busting parameter to prevent CDN caching
					stylesheet.href = fileName + (fileName.includes("?") ? "&" : "?") + "v=" + cacheBuster;
